...
type AddressClient interface {
	...
	DeleteAddress(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*EmptyWithAddress, error)
	UpdateAddress(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*EmptyWithAddress, error)
}
...
func (c *addressClient) GetAddressList(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*AddressListResponse, error) {
	...
	err := c.cc.Invoke(ctx, Address_GetAddressList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addressClient) CreateAddress(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*AddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, Address_CreateAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addressClient) DeleteAddress(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*EmptyWithAddress, error) {
	out := new(EmptyWithAddress)
	err := c.cc.Invoke(ctx, Address_DeleteAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addressClient) UpdateAddress(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*EmptyWithAddress, error) {
	out := new(EmptyWithAddress)
	err := c.cc.Invoke(ctx, Address_UpdateAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddressServer interface {
	...
	DeleteAddress(context.Context, *AddressRequest) (*EmptyWithAddress, error)
	UpdateAddress(context.Context, *AddressRequest) (*EmptyWithAddress, error)
...
func (UnimplementedAddressServer) DeleteAddress(context.Context, *AddressRequest) (*EmptyWithAddress, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteAddress not implemented")
}
func (UnimplementedAddressServer) UpdateAddress(context.Context, *AddressRequest) (*EmptyWithAddress, error) {
