...
type UserFavClient interface {
	...
	AddUserFav(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*EmptyWithUserFav, error)
	DeleteUserFav(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*EmptyWithUserFav, error)
	GetUserFavDetail(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*EmptyWithUserFav, error)
}
...
func (c *userFavClient) GetFavList(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*UserFavListResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserFav_GetFavList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userFavClient) AddUserFav(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*EmptyWithUserFav, error) {
	out := new(EmptyWithUserFav)
	err := c.cc.Invoke(ctx, UserFav_AddUserFav_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userFavClient) DeleteUserFav(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*EmptyWithUserFav, error) {
	out := new(EmptyWithUserFav)
	err := c.cc.Invoke(ctx, UserFav_DeleteUserFav_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userFavClient) GetUserFavDetail(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*EmptyWithUserFav, error) {
	out := new(EmptyWithUserFav)
	err := c.cc.Invoke(ctx, UserFav_GetUserFavDetail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserFavServer interface {
	...
	AddUserFav(context.Context, *UserFavRequest) (*EmptyWithUserFav, error)
	DeleteUserFav(context.Context, *UserFavRequest) (*EmptyWithUserFav, error)
	GetUserFavDetail(context.Context, *UserFavRequest) (*EmptyWithUserFav, error)
...
func (UnimplementedUserFavServer) AddUserFav(context.Context, *UserFavRequest) (*EmptyWithUserFav, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddUserFav not implemented")
}
func (UnimplementedUserFavServer) DeleteUserFav(context.Context, *UserFavRequest) (*EmptyWithUserFav, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteUserFav not implemented")
}
func (UnimplementedUserFavServer) GetUserFavDetail(context.Context, *UserFavRequest) (*EmptyWithUserFav, error) {
