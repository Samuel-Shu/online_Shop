...
func (c *userClient) UpdateUser(ctx context.Context, in *UpdateUserInfo, opts ...grpc.CallOption) (*MyEmpty, error) {
	out := new(MyEmpty)
...
func (UnimplementedUserServer) UpdateUser(context.Context, *UpdateUserInfo) (*MyEmpty, error) {
